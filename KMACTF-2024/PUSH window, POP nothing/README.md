...
`AddVectoredExceptionHandler` sẽ thêm `write_read_pipe_command_5` vào vectored exception handler.
...
Từ đây, ta cần tìm chuỗi `data` sao cho sau khi encode thành base64, chuỗi base64 này bằng với chuỗi `target`.
